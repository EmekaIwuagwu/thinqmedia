...
import { updatePost, getPostById } from "@/app/actions/blog";
        ...
        <div>
            <div className="flex justify-between items-end mb-10">
                <div>
                    ...
                    <h1 className="text-4xl font-black text-accent mb-2">Edit Post</h1>
                    <p className="text-gray-500 font-medium">Update your performance insight.</p>
                </div>
